           ...
           <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                       <h1 class="py-4">Rendez-Vous Manqués</h1>
                          <div id="result">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="table-responsive">
                               <?php $select = "SELECT * FROM rendez_vous_gpl WHERE jour < CURDATE() AND statut IS null";
...
if(isset($_POST['validate-Rdv']))
{
    ...
    $query = "update rendez_vous_gpl SET statut = 'validé', date_validation = CURDATE() WHERE rendez_vous_gpl.id='$id'";
